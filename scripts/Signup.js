class Signup {
    constructor () {
      ...
      this.destinoInput = document.querySelector("#destino");
      this.viajeInput = document.querySelector("#viaje");
    ...
    saveData = (event) => {
      ...
      const destino = this.destinoInput.value;
      const viaje = this.viajeInput.value;
      const email = this.emailInput.value;
      const password = this.passwordInput.value;
      const repeatPassword = this.repeatPasswordInput.value;
  
      const newUser = new User(name, destino, viaje, email, password);
